...
Check & Get Your Desired Product!
 ...
 <div class="  catagory">
  ...
  <button><a href="order.php?heading=<?php echo $heading?>&&">Add to card</a></button>
  <!-- <button><a href="order.php?heading=<?php echo $heading?>&& price=<?php echo $price?>">Add to card</a></button> -->
